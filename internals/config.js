...
const ReactBoilerplate = {
  ...
  dllPlugin: {
    defaults: {
       ...
       */
      exclude: ['chalk', 'compression', 'express', 'ip', 'minimist'],
    ...
    entry(pkg) {
      ...
      const dllPluginDefaults = ReactBoilerplate.dllPlugin.defaults;
      const dllPlugin = pkg.dllPlugin;
      const exclude = dllPlugin.exclude || dllPluginDefaults.exclude;
      const include = dllPlugin.include || dllPluginDefaults.include;
