...
class UserOffersContainer extends Component {
  render() {
    return (
      <div className="userOffers">
        <div className="row">
          <div className="column">
            <h1 className="userOffers__title">Other Gigs By Digitalpartners</h1>
          </div>
        </div>

        <div className="userOffers__carousel">
          <Carousel {...carouselSettings}>
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(() => (
              <div className="userOffers__item" key={generate()}>
...
export default UserOffersContainer;
